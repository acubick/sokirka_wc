...
if ( ! function_exists( 'sokirka_setup' ) ) :
	...
	function sokirka_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'sokirka' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'sokirka_custom_background_args',
				array(
...
function sokirka_scripts() {
	wp_enqueue_style( 'sokirka-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'sokirka-style', 'rtl', 'replace' );

	wp_enqueue_style( 'sokirka-open-iconic-bootstrap', get_template_directory_uri()."/assets/css/open-iconic-bootstrap.min.css", array(), _S_VERSION );
	wp_enqueue_style( 'sokirka-animate', get_template_directory_uri()."/assets/css/animate.css", array(), _S_VERSION );

	wp_enqueue_style( 'sokirka-owl.carousel', get_template_directory_uri()."/assets/css/owl.carousel.min.css", array(), _S_VERSION );
	wp_enqueue_style( 'sokirka-owl.theme.default', get_template_directory_uri()."/assets/css/owl.theme.default.min.css", array(), _S_VERSION );
	wp_enqueue_style( 'sokirka-magnific-popup', get_template_directory_uri()."/assets/css/magnific-popup.css", array(), _S_VERSION );
	...
	wp_enqueue_style( 'sokirka-general', get_template_directory_uri()."/assets/css/general.css", array(), _S_VERSION );
	...
	wp_enqueue_script( 'maps.googleapis', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false', array(), _S_VERSION, true );
...
/**
 * Подключение wooCommerce функций
 */
